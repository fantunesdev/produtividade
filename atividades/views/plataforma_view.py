...
def cadastrar_plataforma(request):
    ...
    return render(request, 'atividades/plataformas/form_plataforma.html', {'form_plataforma': form_plataforma})

def listar_plataformas(request):
    plataformas = plataforma_service.listar_plataformas()
    print(plataformas)
    return render(request, 'atividades/plataformas/listar_plataforma.html', {'plataformas': plataformas} )

def listar_plataforma_id(request, id):
    plataforma = plataforma_service.listar_plataformas(id)
    return render(request, 'atividades/plataformas/expandir_plataforma.html', {'plataforma': plataforma})
